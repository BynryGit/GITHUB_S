    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creation_date', models.DateTimeField(default=django.utils.timezone.now, null=True, blank=True)),
                ...
                ('discount_start_date', models.CharField(default=None, max_length=50, null=True, blank=True)),
                ('discount_end_date', models.CharField(default=None, max_length=50, null=True, blank=True)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.CharField(default=b'1', max_length=2, null=True, blank=True)),
            ],
        ),
        migrations.CreateModel(
            name='CallerDetails',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('AudioRecordingURL', models.URLField(default=None, null=True, blank=True)),
                ...
                ('CallBackParam', models.CharField(default=None, max_length=100, null=True, blank=True)),
        ...
        migrations.CreateModel(
            name='citylife_category',
            fields=[
                ('category_id', models.AutoField(serialize=False, editable=False, primary_key=True)),
                ('category_name', models.CharField(max_length=50, null=True, blank=True)),
                ('creation_date', models.DateTimeField(null=True, blank=True)),
                ('creation_by', models.CharField(max_length=500, null=True, blank=True)),
                ('status', models.CharField(default=b'1', max_length=15, null=True, blank=True, choices=[(b'1', b'1'), (b'0', b'0')])),
                ('city_id', models.ForeignKey(blank=True, to='digispaceapp.City_Place', null=True)),
            ],
        ),
        migrations.CreateModel(
            name='CityStar_Like',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(default=None, max_length=10, null=True, blank=True)),
                ...
                ('experience', models.CharField(default=None, max_length=100, null=True, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consumer_type', models.CharField(default=b'register', max_length=100, null=True, choices=[(b'register', b'register'), (b'guest', b'guest')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(serialize=False, editable=False, primary_key=True)),
                ('status', models.CharField(default=b'like', max_length=100, null=True, blank=True, choices=[(b'like', b'like'), (b'dislike', b'dislike')])),
                ('creation_date', models.DateTimeField(null=True, blank=True)),
            ],
        ),
        migrations.CreateModel(
            name='LikeDislikeReply',
            fields=[
                ('id', models.AutoField(serialize=False, editable=False, primary_key=True)),
                ('status', models.CharField(default=b'like', max_length=100, null=True, blank=True, choices=[(b'like', b'like'), (b'dislike', b'dislike')])),
                ('creation_date', models.DateTimeField(null=True, blank=True)),
        ...
        migrations.CreateModel(
            name='PostComments',
            fields=[
                ('comment_id', models.AutoField(serialize=False, editable=False, primary_key=True)),
                ('comment', models.CharField(max_length=500, null=True, blank=True)),
                ('status', models.CharField(default=b'1', max_length=150, null=True, choices=[(b'1', b'1'), (b'0', b'0')])),
                ('comment_status', models.CharField(default=b'unread', max_length=150, null=True, choices=[(b'read', b'read'), (b'unread', b'unread')])),
                ('creation_date', models.DateTimeField(null=True, blank=True)),
                ('updated_date', models.DateTimeField(null=True, blank=True)),
        ...
        migrations.CreateModel(
            name='PostDetails',
            fields=[
                ('post_id', models.AutoField(serialize=False, editable=False, primary_key=True)),
                ('title', models.CharField(max_length=50, null=True, blank=True)),
                ('description', models.CharField(max_length=500, null=True, blank=True)),
                ('area', models.CharField(max_length=50, null=True, blank=True)),
                ('mood', models.CharField(default=b'positive', max_length=100, null=True, blank=True, choices=[(b'positive', b'positive'), (b'negative', b'negative')])),
                ('share', models.CharField(default=b'0', max_length=100, null=True, blank=True)),
                ('status', models.CharField(default=b'unread', max_length=15, null=True, blank=True, choices=[(b'unread', b'unread'), (b'appropriate', b'appropriate'), (b'inappropriate', b'inappropriate'), (b'deleted', b'deleted')])),
                ('post_status', models.CharField(default=b'unread', max_length=150, null=True, choices=[(b'read', b'read'), (b'unread', b'unread')])),
                ('creation_date', models.DateTimeField(null=True, blank=True)),
                ('creation_by', models.CharField(max_length=500, null=True, blank=True)),
                ('updated_by', models.CharField(max_length=500, null=True, blank=True)),
                ('updation_date', models.DateTimeField(null=True, blank=True)),
                ('deleted_date', models.DateTimeField(null=True, blank=True)),
                ('city_id', models.ForeignKey(to='digispaceapp.City_Place', blank=True)),
                ('citylife_category', models.ForeignKey(to='digispaceapp.citylife_category', blank=True)),
                ('country_id', models.ForeignKey(to='digispaceapp.Country', blank=True)),
                ('user_id', models.ForeignKey(blank=True, to='digispaceapp.ConsumerProfile', null=True)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(serialize=False, editable=False, primary_key=True)),
                ('creation_date', models.DateTimeField(null=True, blank=True)),
                ('post_id', models.ForeignKey(blank=True, to='digispaceapp.PostDetails', null=True)),
                ('user_id', models.ForeignKey(blank=True, to='digispaceapp.ConsumerProfile', null=True)),
            ],
        ),
        migrations.CreateModel(
            name='PostFile',
            fields=[
                ('post_file_id', models.AutoField(serialize=False, editable=False, primary_key=True)),
                ('post_file', models.FileField(max_length=500, null=True, upload_to=b'images/citylife_files/', blank=True)),
        ...
        migrations.CreateModel(
            name='PostReplys',
            fields=[
                ('reply_id', models.AutoField(serialize=False, editable=False, primary_key=True)),
                ('reply', models.CharField(max_length=500, null=True, blank=True)),
                ('status', models.CharField(default=b'1', max_length=150, null=True, choices=[(b'1', b'1'), (b'0', b'0')])),
                ('creation_date', models.DateTimeField(null=True, blank=True)),
                ('updated_date', models.DateTimeField(null=True, blank=True)),
                ('deleted_date', models.DateTimeField(null=True, blank=True)),
                ('comment_id', models.ForeignKey(blank=True, to='digispaceapp.PostComments', null=True)),
                ('user_id', models.ForeignKey(blank=True, to='digispaceapp.ConsumerProfile', null=True)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            name='SellTicketDetails',
            fields=[
                ('sell_ticket_detail_id', models.AutoField(serialize=False, editable=False, primary_key=True)),
        ...
        migrations.CreateModel(
            name='StarImage',
            fields=[
                ('star_image_id', models.AutoField(serialize=False, editable=False, primary_key=True)),
                ('star_image', models.FileField(max_length=500, null=True, upload_to=b'images/user_images/', blank=True)),
                ('creation_date', models.DateTimeField(null=True, blank=True)),
                ('created_by', models.CharField(max_length=500, null=True, blank=True)),
                ('updated_by', models.CharField(max_length=500, null=True, blank=True)),
                ('updation_date', models.DateTimeField(null=True, blank=True)),
                ('star_id', models.ForeignKey(blank=True, to='digispaceapp.CityStarDetails', null=True)),
            ],
        ),
        migrations.CreateModel(
            name='State',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sales_person_contact_number', models.CharField(default=None, max_length=100, null=True, blank=True)),
                ('sales_person_email', models.CharField(default=None, max_length=100, null=True, blank=True)),
                ('title', models.CharField(default=None, max_length=50, null=True, blank=True)),
                ('city_place_id', models.ForeignKey(blank=True, to='digispaceapp.City_Place', null=True)),
                ('country_id', models.ForeignKey(blank=True, to='digispaceapp.Country', null=True)),
                ('parent_supplier_id', models.ForeignKey(blank=True, to='digispaceapp.Supplier', null=True)),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, to='digispaceapp.UserProfile', null=True),
        ),
        migrations.AddField(
            model_name='supplier',
            name='state',
        ...
        migrations.AddField(
            ...
            name='post_id',
            field=models.ForeignKey(blank=True, to='digispaceapp.PostDetails', null=True),
        ),
        migrations.AddField(
            model_name='postcomments',
            name='user_id',
        ...
        migrations.AddField(
            model_name='likedislikereply',
            name='reply_id',
            field=models.ForeignKey(blank=True, to='digispaceapp.PostReplys', null=True),
        ),
        migrations.AddField(
            model_name='likedislikereply',
            name='user_id',
        ...
        migrations.AddField(
            ...
            name='comment_id',
            field=models.ForeignKey(blank=True, to='digispaceapp.PostComments', null=True),
        ),
        migrations.AddField(
            model_name='likedislikecomment',
            name='user_id',

...
crm_urlpatterns = patterns('',
    ...
    url(r'^searching_details/', 'crmapp.views.searching_details',name='searching_details'),
    url(r'^searching_advert/', 'crmapp.views.searching_advert',name='searching_advert'),
    url(r'^get-category-l1/', 'crmapp.views.get_category_l1',name='get_category_l1'),
    url(r'^get-category-l2/', 'crmapp.views.get_category_l2',name='get_category_l2'),
